# 万能解题助手 <Badge type="tip" text="2026/2/2 正常服务" /><Badge type="warning" text="推荐指数🌟🌟🌟🌟++" />

:::tip 本API来自夏柔API（ https://api.aa1.cn/ ）
原文档链接：https://api.aa1.cn/doc/wnjtzs.html **（2026/2/2经duococo编写人员文档时效性检查，原文档与实际有所出入，建议以duococo文档为准！）**
...
## API链接
接口地址： https://yunzhiapi.cn/API/wnjtzs.php 

请求参数：https://yunzhiapi.cn/API/wnjtzs.php?question=1+1=%EF%BC%9F&content=no&type=json
...
```json
{
    ...
    "data": {
        ...
        "metadata": {
            "model": "云智TWOS模型【深度思考】",
            "Website": "https://yunzhiapi.cn/chat/",
            "tokens_used": 233,
